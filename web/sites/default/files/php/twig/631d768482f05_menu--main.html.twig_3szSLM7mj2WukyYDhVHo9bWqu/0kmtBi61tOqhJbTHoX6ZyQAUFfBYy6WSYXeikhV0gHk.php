...
class __TwigTemplate_d5efa1fe4fb25af3ff6086a423ec8ee1e6f928c1b6d6c831a8f68680949966a2 extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 33
                    echo "      <ul";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "nav", 1 => "justify-content-end"], "method", false, false, true, 33), 33, $this->source), "html", null, true);
                    echo ">
    ";
                } else {
                    // line 35
...
$context["item"], "is_expanded", [], "any", false, false, true, 40)) ? ("menu-item--expanded") : ("")), 1 => ((twig_get_attribute($this->env, $this->source,                     // line 41
$context["item"], "is_collapsed", [], "any", false, false, true, 41)) ? ("menu-item--collapsed") : ("")), 2 => ((twig_get_attribute($this->env, $this->source,                     // line 42
...
{% macro menu_links(items, attributes, menu_level) %}
  ...
  {% if items %}
    {% if menu_level == 0 %}
      <ul{{ attributes.addClass('nav', 'justify-content-end') }}>
    {% else %}
      <ul>
    {% endif %}
    {% for item in items %}
  ...
  {% endif %}
{% endmacro %}
", "themes/mytheme/templates/menu--main.html.twig", "/Users/andrewhart/Desktop/sites/theme-site/web/themes/mytheme/templates/menu--main.html.twig");
    }
